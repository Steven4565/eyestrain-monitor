...
def __update_colors():
    global text
    text = __single_color(__theme.get("color").get("text"), __appearance_tracker.appearance_mode)
    global window_bg
    window_bg = __single_color(__theme.get("color").get("window_bg_color"), __appearance_tracker.appearance_mode)
